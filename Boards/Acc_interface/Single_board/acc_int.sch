...
U 1 1 5C7809BA
P 5550 3705
F 0 "U1" H 5735 4568 60  0000 C CNN
F 1 "RJ45_VT" H 5735 4462 60  0000 C CNN
F 2 "footprints:RJ45-Vertical" H 5450 3015 60  0001 C CNN
F 3 "https://www.amphenolcanada.com/ProductSearch/drawings/AC/MRJ548XX1.pdf" H 5550 3115 60  0001 C CNN
F 4 "DK" H 5735 4356 60  0000 C CNN "MFN"
F 5 "MRJ-5481-01-ND" H 5750 3315 60  0001 C CNN "MPN"
F 6 "https://www.digikey.com/products/en?keywords=MRJ-5481-01" H 5950 3515 60  0001 C CNN "PurchasingLink"
	1    5550 3705
	1    0    0    -1  
$EndComp
$Comp
...
F 6 "http://www.te.com/usa-en/product-338070-4.html" H 2315 5250 60  0001 C CNN "PurchasingLink"
	1    2315 3950
	1    0    0    -1  
$EndComp
$Comp
...
F 6 "http://www.te.com/usa-en/product-1-338070-4.html" H 4665 6615 60  0001 C CNN "PurchasingLink"
	1    4665 5315
	1    0    0    -1  
$EndComp
$Comp
...
F 6 "http://www.te.com/usa-en/product-2-338070-0.html" H 2045 6895 60  0001 C CNN "PurchasingLink"
	1    2045 5595
	1    0    0    -1  
$EndComp
$Comp
...
F 6 "http://www.te.com/usa-en/product-338070-6.html" H 7355 5490 60  0001 C CNN "PurchasingLink"
	1    7355 4190
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 5C7815BF
P 8450 1900
F 0 "J6" H 8506 2675 50  0000 C CNN
F 1 "MicroFit_RA_10" H 8506 2584 50  0000 C CNN
F 2 "footprints:MicroFit_RA_10" H 8550 2550 50  0001 C CNN
F 3 "https://www.molex.com/pdm_docs/sd/430451000_sd.pdf" H 8550 2550 50  0001 C CNN
F 4 "DK" H 8450 2550 50  0001 C CNN "MFN"
F 5 "WM1817-ND" H 8550 2650 50  0001 C CNN "MPN"
F 6 "https://www.digikey.com/product-detail/en/molex/0430451000/WM1817-ND/252530" H 8650 2750 50  0001 C CNN "PurchasingLink"
	1    8450 1900
	1    0    0    -1  
$EndComp
...
CAN_HIGH
Text Label 5070 3475 2    50   ~ 0
RESET_BMS
Text Label 5070 3575 2    50   ~ 0
SCK_BMS
Text Label 6400 3275 0    50   ~ 0
MISO_BMS
Text Label 6400 3375 0    50   ~ 0
MOSI_BMS
...
U 1 1 5C781F4A
P 6590 3635
F 0 "#PWR0102" H 6590 3385 50  0001 C CNN
F 1 "GND" H 6595 3462 50  0000 C CNN
F 2 "" H 6590 3635 50  0001 C CNN
F 3 "" H 6590 3635 50  0001 C CNN
	1    6590 3635
	1    0    0    -1  
$EndComp
Text Label 5480 4095 3    50   ~ 0
LED1_BMS
Text Label 5760 4095 3    50   ~ 0
LED2_BMS
Wire Wire Line
	4965 4665 5695 4665
Wire Wire Line
...
U 1 1 5C7822DA
P 5695 4725
F 0 "#PWR0103" H 5695 4475 50  0001 C CNN
F 1 "GND" H 5700 4552 50  0000 C CNN
F 2 "" H 5695 4725 50  0001 C CNN
F 3 "" H 5695 4725 50  0001 C CNN
	1    5695 4725
	1    0    0    -1  
$EndComp
Text Label 4965 4765 0    50   ~ 0
12V
Text Label 4965 4965 0    50   ~ 0
CAN_LOW
Text Label 4965 4865 0    50   ~ 0
CAN_HIGH
Text Label 4965 5465 0    50   ~ 0
RESET_BMS
Text Label 4965 5365 0    50   ~ 0
SCK_BMS
Text Label 4965 5265 0    50   ~ 0
MISO_BMS
Text Label 4965 5065 0    50   ~ 0
5V_BMS
Text Label 4965 5165 0    50   ~ 0
MOSI_BMS
Text Label 4965 5565 0    50   ~ 0
LED1_BMS
Text Label 4965 5665 0    50   ~ 0
LED2_BMS
Text Label 4965 5765 0    50   ~ 0
FAN_PWM
Text Label 4965 5965 0    50   ~ 0
BSPD_Current_sense
Text Label 4965 5865 0    50   ~ 0
BMS_SENSE
$Comp
...
U 1 1 5C782F7D
P 3080 4125
F 0 "#PWR0105" H 3080 3875 50  0001 C CNN
F 1 "GND" H 3085 3952 50  0000 C CNN
F 2 "" H 3080 4125 50  0001 C CNN
F 3 "" H 3080 4125 50  0001 C CNN
	1    3080 4125
	1    0    0    -1  
$EndComp
Text Label 2565 3850 0    50   ~ 0
12V
Text Label 2565 3950 0    50   ~ 0
IMD_SENSE
Wire Wire Line
	2565 3750 3080 3750
Wire Wire Line
...
U 1 1 5C78368B
P 2925 4555
F 0 "#PWR0106" H 2925 4305 50  0001 C CNN
F 1 "GND" H 2930 4382 50  0000 C CNN
F 2 "" H 2925 4555 50  0001 C CNN
F 3 "" H 2925 4555 50  0001 C CNN
	1    2925 4555
	1    0    0    -1  
$EndComp
Text Label 2195 4595 0    50   ~ 0
12V
Text Label 2195 4795 0    50   ~ 0
CAN_LOW
Text Label 2195 4695 0    50   ~ 0
CAN_HIGH
Text Label 2195 5295 0    50   ~ 0
RESET_AIR
Text Label 2195 5195 0    50   ~ 0
SCK_AIR
Text Label 2195 5095 0    50   ~ 0
MISO_AIR
Text Label 2195 4895 0    50   ~ 0
5V_AIR
Text Label 2195 4995 0    50   ~ 0
MOSI_AIR
Text Label 2195 5395 0    50   ~ 0
LED1_AIR
Text Label 2195 5495 0    50   ~ 0
LED2_AIR
Text Label 2195 5595 0    50   ~ 0
IMD_SENSE
...
cooling pressure +\n\ncooling pressure -
Text Label 7605 4040 0    50   ~ 0
12V
Text Label 7605 4140 0    50   ~ 0
TSAL+_R
Text Label 7605 4240 0    50   ~ 0
TSAL-_R
Text Label 7605 4340 0    50   ~ 0
TSAL+_G
Text Label 7605 4440 0    50   ~ 0
TSAL-_G
Wire Wire Line
	7605 3940 8055 3940
Wire Wire Line
...
U 1 1 5C784C8A
P 8055 3985
F 0 "#PWR0107" H 8055 3735 50  0001 C CNN
F 1 "GND" H 8060 3812 50  0000 C CNN
F 2 "" H 8055 3985 50  0001 C CNN
F 3 "" H 8055 3985 50  0001 C CNN
	1    8055 3985
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 5C7850E4
P 10290 1685
F 0 "#PWR0108" H 10290 1435 50  0001 C CNN
F 1 "GND" H 10295 1512 50  0000 C CNN
F 2 "" H 10290 1685 50  0001 C CNN
F 3 "" H 10290 1685 50  0001 C CNN
	1    10290 1685
	1    0    0    -1  
$EndComp
...
Shutdown_MP
Text Notes 9215 2240 0    50   ~ 0
(out, MP -> BMS)
Text Notes 9265 1340 0    50   ~ 0
(in, MP -> BMS)
...
Shutdown_HVD
Text Notes 9255 1745 0    50   ~ 0
(in, BMS -> IMD)
Text Notes 2750 5790 0    50   ~ 0
(BMS shutdown sense)
...
Shutdown_MP
Text Notes 9235 1840 0    50   ~ 0
(out, IMD -> HVD)
Text Notes 9380 1940 0    50   ~ 0
(in, E-stop -> HVD)
Wire Wire Line
	10290 1650 10290 1685
Wire Wire Line
	8700 1650 10290 1650
Text Notes 2870 3190 0    50   ~ 0
(out, E-stop -> HVD)
Text Notes 9255 2045 0    50   ~ 0
(out, HVD -> MP)
...
pin 9, CAN GND
Text Notes 2760 5885 0    50   ~ 0
(IMD shutdown sense)
Text Notes 2760 5990 0    50   ~ 0
(HVD Shutdown Sense)
Text Label 2195 5795 0    50   ~ 0
Shutdown_BMS
Text Label 2195 5895 0    50   ~ 0
Shutdown_IMD
Text Label 2195 5995 0    50   ~ 0
Shutdown_HVD
Text Label 2195 6095 0    50   ~ 0
Shutdown_MP
...
U 1 1 5C789426
P 2960 6490
F 0 "#PWR0110" H 2960 6240 50  0001 C CNN
F 1 "GND" H 2965 6317 50  0000 C CNN
F 2 "" H 2960 6490 50  0001 C CNN
F 3 "" H 2960 6490 50  0001 C CNN
	1    2960 6490
	1    0    0    -1  
$EndComp
Wire Wire Line
